...
car_travel_times = format_travel_times("./input_data/travel_times_matrix_car.csv", STATION_MAPPING, STATION_MAPPING_INT)
walking_travel_times = format_travel_times("./input_data/travel_times_matrix_walk.csv", STATION_MAPPING, STATION_MAPPING_INT)
hamo_travel_times = format_travel_times("./input_data/travel_times_matrix_hamo.csv", STATION_MAPPING, STATION_MAPPING_INT)
