...
def heatmap(log, time):
    ...
    locations = pd.read_csv('./input_data/stations_state.csv').loc[:, ['latitude', 'longitude']]
    ...
    idle_vehicles = log['idle_vehicles'][:, time]
    available_parking = log['available_parking'][:, time]
